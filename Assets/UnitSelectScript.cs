...
public class UnitSelectScript : MonoBehaviour
{
    ...
    private void Command_UnitMove(RaycastHit hit)
    {
        GameObject VFX = Instantiate(Resources.Load<GameObject>("VFX/VFX_Move"), transform.position, Quaternion.identity);
        ...
        {
            unit.UnitAddTargetPos(hit.point);
        }
    }
